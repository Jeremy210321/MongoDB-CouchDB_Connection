...
import couchdb
URL = 'http://Jeremy:IsmaelGarzon2001@localhost:5984'
print(URL)
...
CLIENT = MongoClient("mongodb+srv://ejercicio:ejercicio@cluster0.ctlrq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
DBS=['ExerciseCollections']
 

try:
    dbc=server.create('mongo_destino6')
except:
    dbc=server['mongo_destino6']
